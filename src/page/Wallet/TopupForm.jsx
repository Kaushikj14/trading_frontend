      ...
      <div>
        ...
        <RadioGroup onValueChange ={(value)=>{handlePaymentMethodChange(value)}} className="flex" defaultValue="STRIPE">
            ...
            <div className="flex items-center space-x-2 border p-3 px-5 rounded-md">
                ...
                <Label htmlFor="r1" >
                    <div className=" rounded-md px-5 py-2 w-32 ">
                        <img className="h-9 w-full" src="https://easydigitaldownloads.com/wp-content/uploads/edd/2019/03/stripe-product-image.png" alt="" srcset="" />
                    </div>
                </Label>
            </div>
            ...
            <div className="flex items-center space-x-2 border p-3 px-5 rounded-md">
                ...
                <Label htmlFor="r2" >
                    <div className=" rounded-md px-5 py-2 w-32 ">
                        <img className="h-9 w-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnA99TABOEvVDdjInRpcHjvKZIhgCnv0z9zg&s" alt="" srcset="" />
                    </div>
                </Label>
            </div>
